...
Menu::Menu(ShipmentManager &manager) : manager(manager)
{
}
...
void Menu::handleInput(const char input, ShipmentManager &manager)
{
    switch (input)
    {
    case '1':
...
void Menu::printDriver(const Driver &driver)
{
...
void Menu::printDrivers(ShipmentManager &manager)
{
...
void Menu::printOrder(const Order &order)
{
...
void Menu::printOrders(ShipmentManager &manager)
{
